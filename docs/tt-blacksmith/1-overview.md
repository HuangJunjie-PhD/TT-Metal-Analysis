...
deepwiki: https://deepwiki.com/tenstorrent/tt-blacksmith/1-overview
---
...
For setup instructions, see [Getting Started](https://deepwiki.com/tenstorrent/tt-blacksmith/2-getting-started). For experiment details, see [Experiments](https://deepwiki.com/tenstorrent/tt-blacksmith/6-experiments).
...
The Python package is named `blacksmith` ([setup.py 1-11](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/setup.py#L1-L11)) and provides the core training infrastructure used across all experiments.

Sources: [README.md 18-33](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/README.md?plain=1#L18-L33)[setup.py 1-11](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/setup.py#L1-L11)
...
Sources: [README.md 20-46](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/README.md?plain=1#L20-L46)[docs/src/getting-started.md 22-28](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/docs/src/getting-started.md?plain=1#L22-L28)
...
`source env/activate --xla    # For Tenstorrent hardware (recommended)source env/activate --ffe    # For TT-Forge frontendsource env/activate --gpu    # For GPU development`
...
Sources: [docs/src/getting-started.md 22-28](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/docs/src/getting-started.md?plain=1#L22-L28)[.gitignore 15-21](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/.gitignore#L15-L21)
...
For detailed experiment instructions, configurations, and expected results, see [Experiments](https://deepwiki.com/tenstorrent/tt-blacksmith/6-experiments), [PyTorch Experiments](https://deepwiki.com/tenstorrent/tt-blacksmith/6.1-pytorch-experiments), and [JAX Experiments](https://deepwiki.com/tenstorrent/tt-blacksmith/6.2-jax-experiments).

Sources: [docs/src/getting-started.md 30-37](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/docs/src/getting-started.md?plain=1#L30-L37)
...
*   [Configuration System](https://deepwiki.com/tenstorrent/tt-blacksmith/1-overview#3.3)
*   [Training Infrastructure](https://deepwiki.com/tenstorrent/tt-blacksmith/1-overview#3.5)
*   [Multi-Chip Parallelism Architecture](https://deepwiki.com/tenstorrent/tt-blacksmith/1-overview#3.6)
*   [Models and Datasets](https://deepwiki.com/tenstorrent/tt-blacksmith/5-training-framework)

Sources: [docs/src/experiments.md 46-57](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/docs/src/experiments.md?plain=1#L46-L57)[blacksmith/experiments/torch/llama/xla/lora/README.md 1-170](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/blacksmith/experiments/torch/llama/xla/lora/README.md?plain=1#L1-L170)[README.md 19-48](https://github.com/tenstorrent/tt-blacksmith/blob/fe25eba0/README.md?plain=1#L19-L48)
