...
For specific details about each simulator's configuration, see [Whisper Configuration](/tenstorrent/riscv_arch_tests/4.1-whisper-configuration) and [Spike Integration](/tenstorrent/riscv_arch_tests/4.2-spike-integration). For information about running tests using these simulators, see [Test Execution](/tenstorrent/riscv_arch_tests/3.1-test-execution).
...
Sources: [.gitmodules1-6](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/.gitmodules#L1-L6) [README.md6-7](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L6-L7) [README.md92-105](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L92-L105)
...
Sources: [.gitmodules1-6](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/.gitmodules#L1-L6) [README.md91-105](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L91-L105)
...
Sources: [README.md92-105](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L92-L105)
...
Sources: [README.md97-102](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L97-L102)
...
Sources: [README.md107-110](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L107-L110)
...
1. **Disassembly**: Disassemble the test binary to understand its structure
   ...
   ```
   riscv64-unknown-linux-gnu-objdump  -D > test.dis 
   ```
...
3. **Failure analysis**: Determine if the failure was due to a self-checking mismatch or an exception
   ...
   * For self-checking mismatches, trace back from the  subroutine
   * For exceptions, examine the  subroutine
...
Sources: [README.md91-96](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L91-L96)
...
```
./infra/quals.py --pre-compiled --quals_file  --iss whisper ./infra/quals.py --pre-compiled --quals_file  --iss spike 
```

Comparing the execution traces can help identify differences in interpretation of the RISC-V specification.

Sources: [README.md103-105](https://github.com/tenstorrent/riscv_arch_tests/blob/e54223b0/README.md?plain=1#L103-L105)
