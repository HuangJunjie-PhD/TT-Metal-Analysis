...
```mermaid
graph TD
    subgraph "Compute API (ckernel)"
        TU_Init["llk_unpack_tilize_init"]
        TU_Block["llk_unpack_tilize_block"]
        TU_AB_Init["llk_unpack_tilizeA_B_init"]
    end

    subgraph "LLK Internal Implementation"
        LLK_TU_I["_llk_unpack_tilize_init_"]
        LLK_TU_E["_llk_unpack_tilize_"]
        LLK_TUAB_I["_llk_unpack_tilizeA_B_init_"]
    end

    TU_Init --> LLK_TU_I
    TU_Block --> LLK_TU_E
    TU_AB_Init --> LLK_TUAB_I
```
