...
graph LR
    subgraph "L1_SRAM"
        CB0["Circular_Buffer_0<br/>(operand_A)"]
        CB1["Circular_Buffer_1<br/>(operand_B)"]
        CB2["Circular_Buffer_2<br/>(scalar/broadcast)"]
    end
    
    subgraph "Unpack_Hardware"
        UnpackA["Unpack_A_Unit<br/>llk_unpack_A<br/>llk_unpack_tilize"]
        UnpackB["Unpack_B_Unit<br/>llk_unpack_AB"]
    end
    
    subgraph "Compute_Registers"
        SRCA["SRCA_Register<br/>(16_tiles)"]
        SRCB["SRCB_Register<br/>(16_tiles)"]
    end
    
    subgraph "Math_Pipeline"
        FPU["FPU/SFPU<br/>Compute_Units"]
        DEST["DEST_Register<br/>(output)"]
    end
...
Sources:
[tt_metal/hw/ckernels/blackhole/metal/llk_api/llk_unpack_A_api.h:13-91](),
[tt_metal/hw/ckernels/blackhole/metal/llk_api/llk_unpack_AB_api.h:13-74]()
