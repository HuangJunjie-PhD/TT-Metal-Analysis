...
deepwiki: https://deepwiki.com/tenstorrent/sfpi-gcc/1-overview
---
...
*   Wormhole patterns in `rvtt-wh.md` (TARGET_XTT_TENSIX_WH)
*   Blackhole patterns in `rvtt-bh.md` (TARGET_XTT_TENSIX_BH)
...
| x86/x86_64 | `gcc/config/i386/` | Standard GCC (SSE/AVX patterns in `sse.md`) |
